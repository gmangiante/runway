...
import { MDBDatatable, MDBCard, MDBCardBody, MDBBreadcrumb, MDBBreadcrumbItem } from 'mdb-vue-ui-kit'
...
const goToDetail = async (tableRowIndex: number) => {
  if (data) await router.push({ name: 'modelDetail', params: { id: data[tableRowIndex].id } })
}
